        ...
        <div className="w-full max-w-md p-8 space-y-6 bg-black/60 rounded-lg shadow-md">
          ...
          <form className="space-y-4" onSubmit={handleSignUp}>
            <div>
              ...
              <input type="email" className="w-full px-3 py-2 mt-1 border border-gray-700 rounded-md bg-transparent text-white focus:outline-none:ring" placeholder="email" id="email" value={email} onChange={(e)=>setEmail(e.target.value)}/>
            </div>
            <div>
            ...
            <button type="submit" className="w-full py-2 bg-red-600 text-white font-semibold rounded-md transition duration-300 hover:bg-green-900 hover:shadow-lg hover:scale-105">
              Sign Up
            </button>
